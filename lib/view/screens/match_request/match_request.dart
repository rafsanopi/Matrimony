      ...
      child: Scaffold(
        ...
        body: GetBuilder<MatchReqController>(builder: (controller) {
          return controller.isLoading && controller.dataLoading == false
              ...
              : controller.matchReqList.isEmpty
                  ? const Center(
                      child: CustomText(
                      ...
                      child: Padding(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: controller.dataLoading
                                ? controller.matchReqList.length + 1
                                : controller.matchReqList.length,
                            itemBuilder: (context, index) {
                              var data = controller
                                  .matchReqList[index].participants![0];
                              String id =
                                  controller.matchReqList[index].id.toString();

                              if (index < controller.matchReqList.length) {
