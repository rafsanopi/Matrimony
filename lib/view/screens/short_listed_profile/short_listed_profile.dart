...
import 'package:matrimony/view/screens/short_listed_profile/repo/remove_shortlist.dart';
                            ...
                            itemBuilder: (context, index) {
                              if (index < controller.attributes.length) {
                                return GestureDetector(
                                  ...
                                  child: RequestCard(
                                      button0Ontap: () {
                                        RemoveShortListRepo.removeShortListRepo(
                                            id: controller
                                                .attributes[index].id!);
                                      },
