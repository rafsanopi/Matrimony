...
class NotInterestedListModel {
  int? code;
  String? message;
  Data? data;

  NotInterestedListModel({
    this.code,
    this.message,
    this.data,
  });

  factory NotInterestedListModel.fromRawJson(String str) =>
      NotInterestedListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory NotInterestedListModel.fromJson(Map<String, dynamic> json) =>
      NotInterestedListModel(
        code: json["code"],
