                      ...
                      children: [
                        ...
                        GetBuilder<ProfileController>(builder: (controller) {
                          return controller.isLoading ||
                                  controller.attributes.user!.photo!.isEmpty
                              ? const Center(
                        ...
                        CustomRow(
                            icon: AppIcons.heart,
                            text: AppStaticStrings.sentRequests,
                            ontap: () {
                        ...
                        CustomRow(
                            ...
                            text: AppStaticStrings.notInterestedProfiles,
                            ontap: () {
                              Get.toNamed(AppRoute.notInterestedList);
                            }),
