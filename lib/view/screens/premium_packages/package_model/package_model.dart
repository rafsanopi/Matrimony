                      ...
                      Positioned(
                        ...
                        child: CustomText(
                          ...
                          text: package.duration == 1
                              ? "${package.duration} ${AppStaticStrings.month}"
                              : "${package.duration} ${AppStaticStrings.months}",
                        ),
                      )
                    ],
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      CustomText(
                        ...
                        text: package.isMatchRequestsNoLimit == true
                            ? "${AppStaticStrings.sendCapital} Unlimited ${AppStaticStrings.matchRequest}"
                            : "${AppStaticStrings.sendCapital} ${package.matchRequests} ${AppStaticStrings.matchRequest}",
                      ),
                    ],
                  ),
                ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomText(
                          ...
                          fontSize: 12,
                          fontWeight: FontWeight.w400,
                          text: package.isRemindersNoLimit == true
                              ? "${AppStaticStrings.sendReminderTo} Unlimited ${AppStaticStrings.member}"
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomText(
                          ...
                          fontWeight: FontWeight.w400,
                          text:
                              "${AppStaticStrings.sendupT0} ${package.message} ${AppStaticStrings.person} ${AppStaticStrings.withoutBeingMatch}",
                        ),
                      ),
                    ],
                  ),
