...
//======================No Payment Found Naviagte to Package Screen==================

  static noPaymentFound() {
    return showDialog(
      context: Get.context!,
      builder: (BuildContext context) {
        return Dialog(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const CustomText(
                    text: AppStaticStrings.pleaseUpgradeToPremium,
                    maxLines: 2,
                    fontWeight: FontWeight.w500,
                  ),
                  const Expanded(child: SizedBox()),
                  ...
                  CustomButton(
                    ...
                    textColor: AppColors.pink100,
                    isfillColor: false,
                    text: AppStaticStrings.upgradetoPremium,
                    ontap: () {
                      navigator!.pop();
