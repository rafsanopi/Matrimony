...
class _AboutEditPersonalDetailsState extends State<AboutEditPersonalDetails> {
  ...
  void initState() {
    ...
    debugPrint(personalDetailsController.religionController.text);
    debugPrint(personalDetailsController.casteController.text);
    debugPrint(personalDetailsController.sectController.text);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      onTapClick: () {
                        ...
                        PersonalDetailsPopUps.generateReligionList(
                          onCasteSectSelected: (value) {
                            setState(() {
                              controller.sectController.clear();
                              controller.casteController.clear();

                              ReligionSectCaste.casteSect = value;
                              controller.casteController.text = value;
                            });
                          },
                    ...
                    //     controller.sectController.text.isNotEmpty)
                    CustomText(
                      top: 20,
                      bottom: 8,
                      text: controller.casteController.text.isEmpty
                          ? ReligionSectCaste.casteSect
                    ...
                    CustomTextField(
                      ...
                      onTapClick: () {
                        PersonalDetailsPopUps.generateCasteSectList(
                          ...
                          context: context,
                          onItemSelected: (value) {
                            controller.sectController.text = value;
                          },
                        );
                      },
                      hintText: ReligionSectCaste.casteSect,
                      textEditingController: controller.sectController,
                    ),
