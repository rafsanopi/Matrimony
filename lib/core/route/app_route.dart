...
import 'package:matrimony/view/screens/auth/update_phone_number/update_phn_num.dart';
...
import 'package:matrimony/view/screens/not_interested_list/not_interested_list.dart';
...
import 'package:matrimony/view/widget/profile_custom/inner/aboutProfile/about_personal_details_edit/about_personal_details_edit.dart';
...
class AppRoute {
  ...
  static const String updateNumber = "/update_number";
  ...
  static const String aboutProfileDetailsEdit = "/about_Profile_Details";
  ...
  static const String notInterestedList = "/not_Interested_List";
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: updateNumber, page: () => const UpdatePhone()),
    ...
    GetPage(name: notInterestedList, page: () => const NotInterestedList()),
  ];
}
