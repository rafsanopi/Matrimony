class ApiUrlContainer {
  ...
  //     "http://103.145.138.54:3009/v1/"; //======Local URL======

  static const baseURL =
      "http://167.71.208.193:3009/v1/"; //=======Live URL========
  ...
  //static const socketUrl = "ws://103.145.138.54:3009"; //=======Local=======
  static const socketUrl = "ws://167.71.208.193:3009"; //=======Live=======
  ...
  static const removeShortList = "shortlisted";

  //Not Interested
  static const notInterested = "notInterested";
  static const notInterestedList = "notInterested";
  static const notInterestedRemove = "notInterested";

  //Notification
  static const notification = "notification?page=";
  static const readAllNotification = "notification/read";
  static const singleReadNotification = "notification/";
  ...
  static const unreadMsgCount = "message/unread";
}
